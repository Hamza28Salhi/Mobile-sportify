 ...
 */public class EquipeForm extends BaseForm {
    public EquipeForm(Form previous) {
        ...
        teamButton.addActionListener(e -> new ListEquipesForm(this).show());
        ...
        Button matchesButton = new Button("View Matches");
        matchesButton.addActionListener(e -> new ListMatchesForm(this).show());
        Container matchesContainer = BorderLayout.center(matchesImageViewer).add(BorderLayout.SOUTH, matchesButton);
