...
public boolean updateEquipe(Equipe e) {
    ...
    String url = Statics.BASE_URL1 + "updateEquipeJSON/" + id + "?nom=" + name + "&joueurs=" + joueurs + "&classement=" + classement + "&entraineur=" + entraineur + "&categorie=" + categorie;
...
public boolean deleteEquipe(int id) {
    String url = Statics.BASE_URL1 + "deleteEquipeJSON/" + id;
